...
@TeleOp(name="Transfer Test", group="TeleOp")
public class transfertest extends LinearOpMode {
    ...
    private DcMotor transferMotorRight;

    private DcMotor intakeMotor;

    private DcMotor transferMotor;

    private DcMotor outLeft;

    private DcMotor outRight;

    private Servo leftOutServo;

    private Servo rightOutServo;
    ...
    public void runOpMode() {
        ...
        /* transferMotorLeft = hardwareMap.get(DcMotor.class, "transfer_m_l");
        transferMotorRight = hardwareMap.get(DcMotor.class, "transfer_m_r"); */

        intakeMotor = hardwareMap.get(DcMotor.class, "intake_m");
        transferMotor = hardwareMap.get(DcMotor.class, "transfer_m");
        outLeft = hardwareMap.get(DcMotor.class, "outake_l");
        outRight = hardwareMap.get(DcMotor.class, "outake_r");

        /* leftOutServo = hardwareMap.get(Servo.class, "outserv_l");
        rightOutServo = hardwareMap.get(Servo.class, "outserv_r");
        ...
        while (opModeIsActive()) {
           ...
           /* if (gamepad1.a) {
                transferMotorRight.setPower(1);
            } else if (gamepad1.y) {
                transferMotorLeft.setPower(-1);
            } else if (gamepad1.x) {
                transferMotorLeft.setPower(0);
                transferMotorRight.setPower(0);
            } */
            ...
            if (gamepad1.y) {
                outLeft.setPower(1.0);
                outRight.setPower(1.0);
            } else if (gamepad1.a) {
            ...
            /* if (gamepad1.dpad_up) {
                leftOutServo.setPosition(1);
            } else if (gamepad1.dpad_down) {
                rightOutServo.setPosition(1);
            } else if (gamepad1.dpad_left) {
                leftOutServo.setPosition(0);
            } else if (gamepad1.dpad_right) {
                rightOutServo.setPosition(0);
            }
