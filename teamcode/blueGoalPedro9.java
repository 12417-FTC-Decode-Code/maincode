...
@Autonomous(name = "Blue Goal Pedro 9", group = "Autonomous")
@Configurable
public class blueGoalPedro9 extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower.pathBuilder().addPath(
                            new BezierLine(new Pose(123.046, 122.315).mirror(), new Pose(112.528, 111.289).mirror()))
                    .setLinearHeadingInterpolation(Math.toRadians(40), Math.toRadians(45))
                    .build();

            Path2 = follower.pathBuilder().addPath(
                            new BezierLine(new Pose(112.528, 111.289).mirror(), new Pose(71.914, 119.904).mirror()))
                    .setLinearHeadingInterpolation(Math.toRadians(45), Math.toRadians(180))
                    .build();

            Path3 = follower.pathBuilder().addPath(
                            new BezierCurve(new Pose(71.914, 119.904).mirror(), new Pose(80.579, 80.551).mirror(), new Pose(102.066, 83.543).mirror()))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(0))
                    .build();

            Path4 = follower.pathBuilder().addPath(
                            new BezierLine(new Pose(102.066, 83.543).mirror(), new Pose(125.208, 83.447).mirror()))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                    .build();

            Path5 = follower.pathBuilder().addPath(
                            new BezierCurve(new Pose(125.208, 83.447).mirror(), new Pose(93.477, 93.322).mirror(), new Pose(112.426, 111.482).mirror()))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(45))
                    .build();

            Path6 = follower.pathBuilder().addPath(
                            new BezierCurve(new Pose(112.426, 111.482).mirror(), new Pose(75.553, 55.457).mirror(), new Pose(101.198, 59.228).mirror()))
                    .setLinearHeadingInterpolation(Math.toRadians(45), Math.toRadians(0))
                    .build();

            Path7 = follower.pathBuilder().addPath(
                            new BezierLine(new Pose(101.198, 59.228).mirror(), new Pose(125.193, 59.381).mirror()))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                    .build();

            Path8 = follower.pathBuilder().addPath(
                            new BezierCurve(new Pose(125.193, 59.381).mirror(), new Pose(85.744, 77.688).mirror(), new Pose(112.416, 111.254).mirror()))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(45))
                    .build();

            Path9 = follower.pathBuilder().addPath(
                            new BezierLine(new Pose(112.416, 111.254).mirror(), new Pose(120.579, 94.731).mirror()))
